...
export const SelectorFecha = ({diaCalendar,setDiaCalendar,horaInicioReloj,setHoraInicioReloj,horaFinReloj,setHoraFinReloj,setPoiInicialSelect,vehiculo,setVehiculo,setErrorHora}) => {
  return (
    <div className='selector-uno'>
        ...
        <SelectorHora horaReloj={horaFinReloj} setHoraReloj={setHoraFinReloj} reloj={1} label="Hora de Fin" minHora={horaInicioReloj} setErrorHora={setErrorHora}/>
